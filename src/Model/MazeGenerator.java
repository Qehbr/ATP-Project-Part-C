...
public class MazeGenerator {
    ...
    public void generateMaze(int rows, int cols) {
        ...
        try {
            LOG.info("Generating Maze Start");
            ...
            LOG.info("Maze generation successful\n"+ ServerStrategyGenerateMaze.class.toString() +"\n"+"Rows and cols:" +rows+ cols +"\n"+ client.toString());
        } catch (UnknownHostException e) {
            LOG.error("UnknownHostException in maze generation",e);
            //e.printStackTrace();
        }
    ...
    public void loadMaze(String chosen) {
        ...
        try {
            LOG.info("Loading Maze: reading rows and cols from maze");
            // read maze from file
        ...
        try {
            LOG.info("Loading Maze: reading maze from file");
