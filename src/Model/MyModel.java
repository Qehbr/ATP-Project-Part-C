...
public class MyModel extends Observable implements IModel {
    ...
    public void updatePlayerLocation(MovementDirection direction) {
        ...
        switch (direction) {
            ...
            case DIAUpLeft -> {
                if (((playerCol>0 && generator.getMaze().getMazeMap()[playerRow][playerCol-1]!= 1) ||
                        (playerRow>0 && generator.getMaze().getMazeMap()[playerRow-1][playerCol]!=1))
                        &&(generator.getMaze().getMazeMap()[playerRow-1][playerCol-1]!=1))
            ...
            case DIADownLeft -> {
                if (((playerCol > 0 && generator.getMaze().getMazeMap()[playerRow][playerCol - 1] != 1) ||
                        (playerRow < rows - 1 && generator.getMaze().getMazeMap()[playerRow + 1][playerCol] != 1))
                        &&(generator.getMaze().getMazeMap()[playerRow+1][playerCol-1]!=1))
                    movePlayer(playerRow+1,playerCol-1);
            }
            case DIADownRight -> {
